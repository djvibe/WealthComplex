...
- Wealthsimple’s app may present bot/security defenses to headless browser automation; prefer headed persistent Playwright sessions with manual user login when capturing UI styles or rendered app pages.
